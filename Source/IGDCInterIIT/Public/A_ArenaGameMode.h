...
UCLASS()
class IGDCINTERIIT_API AA_ArenaGameMode : public AGameModeBase
{
	GENERATED_BODY()
public:
	...
	void check_enum_red(int x, int y);
	void check_enum_blue(int x, int y);
	...
	void PrintObjectVectorsIn2DArray(const std::vector<std::vector<AA_Tile*>>& TwoDTileArray);
